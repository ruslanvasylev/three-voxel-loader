...
import { Color, BufferGeometry, MeshPhongMaterial, BoxGeometry, Vector3, Mesh, InstancedMesh, Geometry, VertexColors } from 'three';
...
export class VoxelLoader {
  ...
  generateMesh(octree) {
    ...
    var voxels = new InstancedMesh(bufGeometry, material); //Mesh
